...
public partial class COL2019 : System.Data.Linq.DataContext
{
  ...
  partial void InsertDoneTable(DoneTable instance);
  partial void UpdateDoneTable(DoneTable instance);
  partial void DeleteDoneTable(DoneTable instance);
  ...
  partial void DeleteTaxon(Taxon instance);
	...
	public System.Data.Linq.Table<DoneTable> DoneTable
	{
		get
		{
			return this.GetTable<DoneTable>();
		}
	}
...
[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DoneTable")]
public partial class DoneTable : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    partial void OnTaxonIDChanging(System.Nullable<int> value);
    partial void OnTaxonIDChanged();
    partial void OnMakelangChanging(string value);
    partial void OnMakelangChanged();
    #endregion
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TaxonID", DbType="Int")]
	public System.Nullable<int> TaxonID
	{
		get
		{
		...
		set
		{
			if ((this._TaxonID != value))
			{
				if (this._Taxon.HasLoadedOrAssignedValue)
				{
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Makelang", DbType="VarChar(10)")]
	public string Makelang
	{
		get
		{
			return this._Makelang;
		}
		set
		{
			if ((this._Makelang != value))
			{
				this.OnMakelangChanging(value);
				this.SendPropertyChanging();
				this._Makelang = value;
				this.SendPropertyChanged("Makelang");
				this.OnMakelangChanged();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__DoneTable__Taxon__625A9A57", Storage="_Taxon", ThisKey="TaxonID", OtherKey="TaxonID", IsForeignKey=true)]
	public Taxon Taxon
	{
		get
		{
		...
		set
		{
						...
						|| (this._Taxon.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					this._Taxon.Entity = null;
					previousValue.DoneTable.Remove(this);
				}
				this._Taxon.Entity = value;
				if ((value != null))
				{
					value.DoneTable.Add(this);
					this._TaxonID = value.TaxonID;
				}
				else
				{
...
public partial class Taxon : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<DoneTable> _DoneTable;
	...
	public Taxon()
	{
		...
		this._DoneTable = new EntitySet<DoneTable>(new Action<DoneTable>(this.attach_DoneTable), new Action<DoneTable>(this.detach_DoneTable));
		OnCreated();
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__DoneTable__Taxon__625A9A57", Storage="_DoneTable", ThisKey="TaxonID", OtherKey="TaxonID", DeleteRule="NO ACTION")]
	public EntitySet<DoneTable> DoneTable
	{
		get
		{
			return this._DoneTable;
		}
		set
		{
			this._DoneTable.Assign(value);
		}
	}
	...
	private void attach_DoneTable(DoneTable entity)
	{
		this.SendPropertyChanging();
		entity.Taxon = this;
	}
	
	private void detach_DoneTable(DoneTable entity)
	{
		this.SendPropertyChanging();
		entity.Taxon = null;
	}
